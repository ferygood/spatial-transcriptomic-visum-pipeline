...
![image](results/gene_image_correlation_heatmap.png)
*Figure: Heatmap showing correlations between key marker genes and image textures.*
...
![image](results/spatial_clusters.png)
*Figure: Plot the top 5 SVGs to projection*
